...
const nodeLayout: Array<{
  ...
  { id: "delay", type: "delay", x: 760, y: 310 },
  { id: "parallel", type: "parallel", x: 1010, y: 310 },
  { id: "condition", type: "condition", x: 1260, y: 310 },
  { id: "subworkflow", type: "subworkflow", x: 1510, y: 160 },
  { id: "loop", type: "loop", x: 1510, y: 440 },
  { id: "wait", type: "wait-event", x: 1260, y: 560 },
  { id: "end", type: "end", x: 1760, y: 310 },
];
...
const edgeSpecs: Array<[string, string, string, string, string]> = [
  ...
  ["action-delay", "action", "success", "delay", "input"],
  ["action-loop", "action", "failure", "loop", "input"],
  ["delay-parallel", "delay", "completed", "parallel", "input"],
